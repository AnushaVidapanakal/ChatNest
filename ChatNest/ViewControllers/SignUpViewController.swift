...
class SignUpViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // To handle a tap event on the view and dismiss the keyboard
    ...
    // Spinner to show the loading of the view
    ...
    // To add observers for UIKeyboardWillShow and UIKeyboardWillHide notifications
    func addObservers(){
